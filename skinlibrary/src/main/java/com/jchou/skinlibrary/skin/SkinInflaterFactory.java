...
import com.jchou.skinlibrary.skin.attrs.AttrFactory;
import com.jchou.skinlibrary.skin.attrs.DynamicAttr;
import com.jchou.skinlibrary.skin.attrs.SkinAttr;
import com.jchou.skinlibrary.skin.config.SkinConfig;
import com.jchou.skinlibrary.skin.entity.SkinItem;
...
public class SkinInflaterFactory implements LayoutInflaterFactory {
    ...
    private View createView(Context context, String name, AttributeSet attrs) {
        ...
        try {
            if (-1 == name.indexOf('.')) {
                ...
                if (view == null) {
                    view = LayoutInflater.from(context).createView(name, "android.widget.", attrs);//系统组件
                }
                if (view == null) {
    ...
    private void parseSkinAttr(Context context, AttributeSet attrs, View view) {
        ...
        if (!ListUtils.isEmpty(viewAttrs)) {
            ...
            skinItem.setSkinAttrs(viewAttrs);
