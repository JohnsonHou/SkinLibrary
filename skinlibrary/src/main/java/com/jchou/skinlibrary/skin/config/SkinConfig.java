package com.jchou.skinlibrary.skin.config;

import android.content.Context;

import com.jchou.skinlibrary.skin.util.PreferencesUtils;
...
public class SkinConfig {
    ...
    public static final String PREF_CUSTOM_SKIN_PATH = "cn_jc_skin_custom_path";
    public static final String DEFALT_SKIN = "cn_jc_skin_default";//默认皮肤
    public static final String SKIN_FROM = "cn_jc_skin_from";
